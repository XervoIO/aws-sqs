 ...
 * @config {number} [VisibilityTimeout] The length of time (in seconds) that a
 ...
 * @config [Policy] The formal description of the permissions for a resource.
 ...
 * @config [MaximumMessageSize] The limit of how many bytes a message can
 ...
 * @config [MessageRetentionPeriod] The number of seconds Amazon SQS retains a
 * message. Integer representing seconds, from 60 (1 minute) to 1209600
 * (14 days). The default for this attribute is 345600 (4 days).
 * @config [DelaySeconds] The time in seconds that the delivery of all messages
 ...
 * @config {number} [MaxNumberOfMessages] The max number of messages to pull
 * from queue.
 * @config {number} [VisibilityTimeout] The length of time in seconds that a
