 ...
 * @param {object} opts (optional) optional parameters
 * @param {string} opts.region (optional) the aws region, must be one of these:
 ...
 * @param  {object} attrs (optional) Attributes for the queue.
 * @param {number} attrs.VisibilityTimeout (optional) The length of time (in seconds) that a
 ...
 * @param attrs.Policy (optional) The formal description of the permissions for a resource.
 ...
 * @param attrs.MaximumMessageSize (optional) The limit of how many bytes a message can
 ...
 * @param attrs.MessageRetentionPeriod] The number of seconds Amazon SQS retains a
 * message. Integer representing seconds, from 60 (1 minute) to 1209600
 * (14 days). The default for this attribute is 345600 (4 days).
 * @param attrs.DelaySeconds (optional) The time in seconds that the delivery of all messages
 ...
 * @param  {string} prefix (optional) Queue name prefix to filter the list of queues to
 * return.
 ...
 * @param  {number} delay (optional) The delay to wait before the message is actually
 * visible in the queue.
 * @param  {Function} fn The callback for when the message is add to queue,
 * Callback function should take two parameters, error and result which is
 * and the message details.
 * @see SQS.prototype.sendMessageBatch
 * @memberOf SQS
 */
 ...
 * @param  {object} opts (optional) Options for retreiving messages.
 * @config {number} opts.MaxNumberOfMessages (optional) The max number of messages to pull
 * from queue.
 * @config {number} opts.VisibilityTimeout (optional) The length of time in seconds that a
 ...
 * @see SQS.prototype.deleteMessage
 * @memberOf SQS
 */
 ...
 * include an err (or null).
 * @see SQS.prototype.deleteMessageBatch
 * @memberOf SQS
 */
