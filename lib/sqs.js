 ...
 * @config {string} [region] the aws region, must be one of these:
 ...
 * @param  {object} [attrs] Attributes for the queue, possible attributes include:
 ...
 *     A valid form-url-encoded policy. For more information about policy structure, see Basic Policy Structure in the Amazon SQS Developer Guide. For more information about form-url-encoding, see http://www.w3.org/MarkUp/html-spec/html-spec_8.html#SEC8.2.1.
 *   MaximumMessageSize - The limit of how many bytes a message can contain before Amazon SQS rejects it.
 *     An integer from 1024 bytes (1 KiB) up to 65536 bytes (64 KiB). The default for this attribute is 65536 (64 KiB).
 *   MessageRetentionPeriod - The number of seconds Amazon SQS retains a message.
 *     Integer representing seconds, from 60 (1 minute) to 1209600 (14 days). The default for this attribute is 345600 (4 days).
 ...
 *   Callback function takes two parameters error and result, result will be full name for the queue
 */
SQS.prototype.createQueue = function(name, attrs, fn) {
  ...
  if(name.length > 80 || name.search(" ") != -1) {
    fn('Name is constrained to maximum 80 characters; alphanumeric characters, hyphens (-), and underscores (_).', null);
    return;
  }
